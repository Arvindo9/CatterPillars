 ...
 */
public class WalletFragment extends BaseFragment<FragmentMemberDetailBinding, WalletViewModel>
    ...
    public static final String PAYMENT_WALLET = "2";
    public static final String SHOPING_WALLET = "3";
    ...
    private AppCompatEditText startDateD;
    private AppCompatEditText endDateD;
    private AppCompatEditText transactionIdD, topFilterCountEditText;
    private String startDateS = "";
    private String endDateS = "";
    private String transactionIdS = "";
    private String topListCountS = "Show 10 Transaction";
    private String selectedTopListCountId = "10";
    private HashMap<String, String> listCountStatusMap = new HashMap<>();
    private String[] topCountStringArray = {"Show 10 Transaction", "Show 50 Transaction", "Show All Transaction"};
    ...
    public static WalletFragment newInstance(String title, String dataType) {
    ...
    protected void init() {
        ...
        listCountStatusMap.put("Show 10 Transaction", "10");
        listCountStatusMap.put("Show 50 Transaction", "50");
        listCountStatusMap.put("Show All Transaction", "0");
        binding.listView.setHasFixedSize(true);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(activity);
        binding.listView.setLayoutManager(mLayoutManager);

        adapter = new WalletAdapter(context, WalletFragment.this, list, viewModel);
    ...
    private void onListCountFilter() {
        ...
        builde.setTitle("Select Top Transaction List Count");
    ...
    void api(int index, boolean isFilterApply) {
        ...
        Call<WalletViewModel> call = null;// = apiService.checkSheetDetails(module, "", "");

        if (index == FIRST_API_LOAD) {
            call = apiService.walletDetails(preferencesService.getUMobile(), startDateS, endDateS,
        ...
        if (call != null) {
            call.enqueue(new retrofit2.Callback<WalletViewModel>() {
                @Override
                public void onResponse(@NonNull Call<WalletViewModel> call, @NonNull
                        Response<WalletViewModel> response) {
                ...
                @Override
                public void onFailure(@NonNull Call<WalletViewModel> call, @NonNull Throwable t) {
                    t.printStackTrace();
                    call.cancel();
                    loader.dismiss();
